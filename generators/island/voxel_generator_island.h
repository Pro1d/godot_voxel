...
#define PARAMETER_BIND(TYPE, NAME, ...) \
	...
	ADD_PROPERTY(PropertyInfo(Variant::TYPE, #NAME, __VA_ARGS__), "set_"#NAME, "get_"#NAME);
...
public:
	...
	PARAMETER_SET_GET_DECL(float, biome_transition);
	...
	RES_PARAMETER_SET_GET_DECL(OpenSimplexNoise, cliff_noise);
	PARAMETER_SET_GET_DECL(float, cliff_noise_factor);
